        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="table-bootstrap-basic.html" class="ai-icon" aria-expanded="false">
						<i class="flaticon-025-dashboard"></i>
						<span class="nav-text">Panne</span>
					</a>
				</li>
					<li><a href="table-bootstrap-basic.html" class="ai-icon" aria-expanded="false">
						<i class="flaticon-025-dashboard"></i>
						<span class="nav-text">Employe</span>
					</a>
				</li>
					<li><a href="table-bootstrap-basic.html" class="ai-icon" aria-expanded="false">
						<i class="flaticon-025-dashboard"></i>
						<span class="nav-text">Prestataire</span>
					</a>
				</li>
					<li><a href="categorie.php" class="ai-icon" aria-expanded="false">
						<i class="flaticon-025-dashboard"></i>
					...
					<li><a href="table-bootstrap-basic.html" class="ai-icon" aria-expanded="false">
						<i class="flaticon-025-dashboard"></i>
						<span class="nav-text">Equipement</span>
						</a>
					</li>
